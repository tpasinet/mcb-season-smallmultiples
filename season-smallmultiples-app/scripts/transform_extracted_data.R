...
season_schedule <- season_schedule_extracted %>%
  ...
  # Determine if the game was a home game for the team whose schedule is being transformed.
  ...
  select(team_id, season_year, game_id, game_index, game_date, opponent_id, opponent, is_home_game, is_win,
         score_team_total, score_opponent_total)
